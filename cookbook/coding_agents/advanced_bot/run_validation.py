#!/usr/bin/env python3
"""
Validation Bot Task Runner

This script allows running the validation bot with a user prompt,
triggering the full validation flow including testing and sequential thinking.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Validation Bot Task Runner")
